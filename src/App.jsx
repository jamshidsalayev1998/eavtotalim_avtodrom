                ...
                default:
                    return (
                        <>
                            ...
                            <Route component={ComputerSettingsPage} path="/computer-test" exact/>
                            <Route component={UserComputerConfigPage} path="/computer-config-settings" exact/>
                            <Route component={thirdApplication} path="/third-application" exact/>
                            <Redirect to={localStorage.getItem('computer_key')?"computer-test":"/login"}/>
                        </>
                    );
            }
        } else {
