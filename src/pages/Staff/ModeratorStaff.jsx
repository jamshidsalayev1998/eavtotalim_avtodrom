...
const ModeratorStaff = ({ data, isLoad }) => {

    return (
        <React.Fragment>
            {data !== null && isLoad !== null && <div>
                <div className="top-organizations">
                    <h5 className="font-weight-bold">Moderator</h5>
                                            ...
                                            <Tr key={index}>
                                                ...
                                                <Td className="table_body " style={{ widTd: "80px" }}>
                                                    <div className="func_buttons">
                                                        ...
                                                        <span><i className="bx bx-trash font-size-22 text-danger"></i></span>
                                                    </div>
                                                </Td>
                                            </Tr>
                                        )
