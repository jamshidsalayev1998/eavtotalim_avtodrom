                    ...
                    <Card>
                        <CardBody>
                            <div className="top-organizations">
                                <h5 className="text-dark">{t("O`quvchilarni to`lovlarini tasdiqlash (Nazariy)")}</h5>
                            </div>
                            <div className="crypto-buy-sell-nav mt-3">
                                <Tabs defaultActiveKey={default_tab ? default_tab : '1'} onChange={change_tab}>
                                    <TabPane tab="Tasdiqlanmaganlar" key="1">
                                        <StudentPaymentNotConfirmedsIndex setFirstTabLoading={setFirstTabLoading}
                                    ...
                                    <TabPane tab="Tasdiqlanganlar" key="2">
                                        <StudentPaymentConfirmedsIndex secondTabLoading={secondTabLoading}
