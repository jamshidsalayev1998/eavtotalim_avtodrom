                    ...
                    <Card>
                        <CardBody>
                            <div className="top-organizations">
                                <h5 className="text-dark">{t("O`quvchini to`lovini tasdiqlash (Amaliy)")}</h5>
                            </div>
                            <div className="crypto-buy-sell-nav mt-3">
                                <Row className="justify-content-between">
                                    ...
                                    <Col xl={6} className={'d-flex justify-content-end'}>
                                        <button className={'btn btn-outline-danger'} onClick={clearAllData}><i className={'fa fa-times'}></i></button>
                                    </Col>
                                </Row>
                                {
                                    data != null &&
                                    <Row className={'pt-5'} style={{fontSize: '25px'}}>
                                        ...
                                        <Col xl={24} className={'text-center'}>
                                            <Col xl={6} className={'ml-auto mr-auto'}>
                                                {data?.payment_status ?
                                                    <button className={'btn btn-outline-danger p-3 w-100'}>Nazariy
                                                        imtihon uchun to'lovni <b>Bekor
                                                            qilish</b></button> :
                                                    <button
