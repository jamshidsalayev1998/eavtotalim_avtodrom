...
const QrCodeScannerPage = props => {
        ...
        (async () => {
            ...
            if (response?.data?.status == 1) {
                ...
                if (parseInt(response?.data?.data?.payment_status) === 0) {
                    ...
                    confirm_payment()
                } else if (parseInt(response?.data?.data?.payment_status) === 1 && parseInt(response?.data?.data?.exam_result) === 1 && parseInt(response?.data?.data?.practical_payment_status) !== 1) {
    ...
    return (
        <>
            <Modal title={'To`lovni tasdiqlash'}
            ...
            >
                ...
                >
                    <Form.Item
                        ...
                        initialValue={examinationAreaPaymentTypes.length > 0 ? examinationAreaPaymentTypes[0]?.id : ''}
                    >
                        <Select
                            showSearch
                            style={{width: "100%"}}
                    ...
                    <Card>
                        <CardBody>
                            <div className="top-organizations">
                                <h5 className="text-dark">{t("O`quvchini to`lovini tasdiqlash (Nazariy)")}</h5>
                                        ...
                                        <Col xl={12} className={' justify-content-end'}>
                                            ...
                                            <div className={'w-100'}>
                                                {parseInt(data?.exam_result) === 1 ?
                                                    <Badge color={'success'}>Nazariy imtihondan o'tgan</Badge> :
                                                    parseInt(data?.exam_result) === 0 ?
                                                        <Badge color={'danger'}>Nazariy imtihondan o'ta
                                                            olmagan</Badge> :
                                                        <Badge color={'warning'}>Nazariy imtihon topshirmagan</Badge>
                                                }

                                            </div>
                                            <div className={'w-100'}>
                                                {parseInt(data?.practical_payment_status) === 1 ?
                                                    <Badge color={'success'}>Amaliy imtihonga to'lov
                                                        tasdiqlangan</Badge> :
                                                    <Badge color={'danger'}>Amaliy imtihonga to'lov
                                                        tasdiqlanmagan</Badge>
                                                }
                                            ...
                                            <div className={'w-100'}>
                                                {parseInt(data?.practical_exam_result) === 1 ?
                                                    <Badge color={'success'}>Amaliy imtihondan o'tgan</Badge> :
                                                    parseInt(data?.practical_exam_result) === 0 ?
                                                        <Badge color={'danger'}>Amaliy imtihondan yiqilgan</Badge> :
                                                        <Badge color={'warning'}>Amaliy imtihon topshirmagan</Badge>
                                                }
                                        ...
                                        <Col xl={24} className={'text-center'}>
                                            <Col xl={6} className={'ml-auto mr-auto'}>
                                                ...
                                                <button
                                                    ...
                                                    onClick={confirm_payment}>Nazariy imtihon uchun
                                                    to'lovni <b>Tasdiqlash</b></button>
                                                }
                                            </Col>
