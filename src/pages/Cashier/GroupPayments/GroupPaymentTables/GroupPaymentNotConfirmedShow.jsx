...
const GroupPaymentNotConfirmedShow = ({}) => {
  ...
  const change_ex_pay_type = e => {
    let selected_type = filters?.examination_area_payment_types.find(
      element => {
        return element?.id == e;
      }
    );
              ...
              <div className="top-organizations">
                <div className="top_links_page_title">
                  ...
                  <h5 className="text-dark">
                    ...
                    guruhi to'lovini tasdiqlash (
                    <b>{group?.organization?.name_uz}</b>)
                  </h5>
                </div>
                <div>
                ...
                >
                  ...
                  <Col xl={6} className={"ml-2"}>
                    ...
                    {selectedExPayType ? (
                      <NumberFormat
                        value={
                          parseInt(selectedExPayType?.amount) *
                          selected_keys?.length
                        }
