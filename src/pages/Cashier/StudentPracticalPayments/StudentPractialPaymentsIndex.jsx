...
import StudentPracticalPaymentNotConfirmedsIndex from "./StudentPracticalPaymentTables/StudentPracticalPaymentNotConfirmedsIndex";
import StudentPracticalPaymentConfirmedsIndex from "./StudentPracticalPaymentTables/StudentPracticalPaymentConfirmedsIndex";
          ...
          <Card>
            <div>
              <h5 className="text-dark">
                {t("O`quvchilarni to`lovlarini tasdiqlash (Amaliy)")}
              </h5>
            </div>
            <div>
              <Tabs
              ...
              >
                <TabPane tab="Tasdiqlanmaganlar" key="1">
                  <StudentPracticalPaymentNotConfirmedsIndex
                ...
                <TabPane tab="Tasdiqlanganlar" key="2">
                  <StudentPracticalPaymentConfirmedsIndex
