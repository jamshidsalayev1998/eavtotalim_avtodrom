...
const StudentPracticalPaymentConfirmedsIndex = ({ secondTabLoading }) => {
  const { Option } = Select;
                ...
                return (
                  <Tr key={index} className={"hover-tr-success"}>
                    ...
                    <Td>
                      <NavLink
                        to={
                          "/cashier/student-payments/" +
                          element?.examination_area_payment?.id
                        }
                      >
                        {element?.student_fio}
                      </NavLink>
                    ...
                    <Td className={"text-center"}>
                      {
                        element?.examination_area_payment
                          ?.examination_area_payment_type?.name
                      }{" "}
                      / {element?.examination_area_payment?.payment_type?.name}
                    </Td>
                    <Td className={"text-center"}>
                      <Popconfirm
                        placement={"left"}
                        title={"To`lovni bekor qilasizmi ?"}
                        onConfirm={e => cancel_payment(element)}
                        okText={"Ha"}
                        cancelText={"Yo`q"}
                      >
...
export default withTranslation()(StudentPracticalPaymentConfirmedsIndex);
