...
const TestComponent = ({
  ...
  useEffect(() => {
    ...
    const computer_key = localStorage.getItem("computer_key");
    if (token) {
      axios({
                ...
                {rightAnswerData?.answer_description && (
                  <div className="d-flex justify-content-center align-items-center">
                    <div className="d-flex justify-content-center align-items-center mr-3">
                      <div className="d-flex justify-content-center align-items-center">
                        <span className="text-white mx-1">To'g'ri javob</span>
                        <BsFillCircleFill style={{ color: "#27AE60" }} />
                      </div>

                      <div className="d-flex justify-content-center align-items-center">
                        <span className="text-white mx-1">Noto'g'ri javob</span>
                        <BsFillCircleFill style={{ color: "#EB5757" }} />
                      </div>
                      ...
                      <div className="d-flex justify-content-center align-items-center">
                        ...
                        <BsFillCircleFill style={{ color: "#fff" }} />
                      </div>
                    </div>
