...
const TestComponent = ({
    ...
    const [languages, setLanguages] = useState([
        {id: 1, value: "uz", language: "O'zbek", image: uzFlag, functionalKey: 'F1'},
        {id: 3, value: "kr", language: "Ўзбек", image: uzFlag, functionalKey: 'F2'},
        {id: 5, value: "qq", language: "Qaraqalpaqsha", image: qqFlag, functionalKey: 'F3'},
        {id: 2, value: "ru", language: "Pусский", image: ruFlag, functionalKey: 'F4'},
    ]);
                        ...
                        checked_test?.selected_answer_id == item?.id ? (
                            ...
                            <div className={"d-flex justify-content-end"}>
                                {rightAnswerData?.answer_description && (
                                    <Button onClick={showAnswerDescription}>
                ...
                <div className="row">
                    ...
                    {languages?.map((item, index) => (
                        <div key={index} className="col-12 px-5 d-flex">
                            <div className={'select-test-lang d-flex justify-content-center align-items-center'}
            ...
            >
                <div>
                    ...
                    <div className="text-center">
                        ...
                        >
                            <span>{t("Testni Boshlash")}</span> <span className={'functional_key ml-3 '}
                                                                      style={{width: 'auto'}}>Enter <AiOutlineEnter/></span>
                        </button>
                    </div>
                </div>
            </Modal>
