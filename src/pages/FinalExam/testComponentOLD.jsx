...
const TestComponent = ({settest_time, test_time, setIsStarted, isStarted, isTestEndedModalVisible, setIsTestEndedModalVisible, setTestResult, setIsFinishedTime, templateTestTime, testResult, logout}) => {
        ...
        if (token) {
            axios({
                ...
                if (res?.data?.status == "1") {
                    setuserFullName(res?.data?.final_test_attempt?.final_test_student_access?.student_fio)
    ...
    return (
        <div className="final_test_div" onKeyDown={handleKeyBtn} tabIndex="1">
            <div>
                <h4 className="mt-3" style={{color: "#434343"}}>{userFullName}</h4>
                <div className="buttons  align-items-center justify-content-center mt-3 bg-white "
                    ...
                    <div className={'d-flex justify-content-between align-items-center mr-5 '}>
                        ...
                        <div className={'d-flex align-items-center'}>
                            ...
                            <div>
                                <i className="fas fa-sign-out-alt ml-4" onClick={logout}
                                   style={{fontSize: "32px", color: "#999", cursor: "pointer"}}></i>
                            </div>
                ...
                <div className="row  ">
                        ...
                        <div className="test_content ">
                            <div className="d-flex justify-content-end ">
                                <Button
                                    ...
                                    type="primary"
                                    disabled={checked_test?.result === "" && selectedAnswerId ? false : true}
                                    onClick={() => checkTest(selectedAnswerId)}
                                    icon={pressedKey && <span className={'functional_key_small'}>
                                        ...
                                        <div
                                            ...
                                            className={`${
                                                ...
                                                checked_test?.selected_answer_id == item?.id
                                                    ? "answer_incorrect"
                                                    : checked_test?.result === "" &&
                                                    selectedAnswerId == item?.id ? "selectedAnswer"
                    ...
                    <div className="col-12 col-md-7 d-flex justify-content-center " style={{objectFit: 'cover'}}>
            ...
            >
                <div className="">
                    <p>
                        <i class="fa fa-question-circle" aria-hidden="true"></i> Test <b>20 ta savoldan</b> iborat
                        bo'ladi.
                    </p>
                    <p>
                        <i class="fa fa-clock text-warning" aria-hidden="true"></i> Testni yechish uchun sizga <b>25
                        daqiqa</b> vaqt beriladi.
                    </p>
                    <p>
                        <i class="fa fa-random" aria-hidden="true"></i> Test savollari ketma ketlik tartibini hohlagan
                        tarzda yechish mumkin.
                    </p>
                    <p>
                        <i class="fa fa-exclamation-circle" aria-hidden="true"></i> Har bitta savol uchun maqul javobni
                        belgilaganingizda darhol javobingiz natijasi ko`rsatiladi
                    </p>
                    <p>
                        <i class="fa fa-check-circle text-success" aria-hidden="true"></i> Testdan o'tish uchun
                        kamida <b>18 ta savolga to'g'ri</b> javob belgilashingiz lozim.
                    </p>
                    <p>
                        <i class="fa fa-exclamation-triangle text-danger" aria-hidden="true"></i> Ikkitadan ko'p savolga
                        noto'g'ri javob belgilasangiz urinishingiz yakunlanadi va testdan o'tmagan hisoblanasiz
                    </p>
                    <p>
                        <i class="fa fa-exclamation-circle text-info" aria-hidden="true"></i> Tayyor bo'lsangiz testni
            ...
            >
                <div className="">
                    ...
                    <div className="text-center">
                        <button onClick={() => settime_finished(false)} className="btn btn-light">
                            Testni Boshlash
                        </button>
                    </div>
                </div>
