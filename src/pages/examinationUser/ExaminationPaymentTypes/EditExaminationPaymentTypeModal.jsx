...
const EditExaminationPaymentTypeModal = ({setIsEditModalVisible, isEditModalVisible,reload,setReload,selectedElement,setSelectedElement,editForm}) => {
    const {Option} = Select;
    const handleOk = () => {
        editForm.submit()
    };
    ...
    const onFinishEdit = (values) => {
        (
            async () => {
                const response = await updateExaminationPaymentType(values , editForm.getFieldValue('id'));
    ...
    return (
        <>
            <Modal title="To`lov turini o`zgartirish"
