    ...
    return (<>
        <div>
            <div className={'pl-3 pt-3'}>
                <p><b>F.I.O:</b> {selectedStudent?.student_fio}</p>
                <p><b>Pasport:</b> {selectedStudent?.student_passport}</p>
                <p><b>Kelish
                ...
                <p>
                    ...
                    {selectedStudent?.payment_status ? <Badge color={'success'}>To'lov qilingan</Badge> :
                        <Badge color={'danger'}>To'lov
                            qilinmagan</Badge>}/{selectedStudent?.practical_payment_status ?
                ...
                <p>
                    ...
                    {selectedStudent?.exam_result == 1 ?
                        <Badge color={'success'}>O`tgan</Badge> : selectedStudent?.exam_result == 0 ?
                            <Badge color={'danger'}>Yiqilgan</Badge> : <Badge color={'warning'}>Topshirmagan</Badge>

                    }/{selectedStudent?.practical_exam_result == 1 ?
                    <Badge color={'success'}>O`tgan</Badge> : selectedStudent?.practical_exam_result == 0 ?
                        <Badge color={'danger'}>Yiqilgan</Badge> : <Badge color={'warning'}>Topshirmagan</Badge>
