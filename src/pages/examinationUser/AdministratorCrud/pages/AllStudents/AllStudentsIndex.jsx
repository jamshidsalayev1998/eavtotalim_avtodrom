...
const AllStudentsIndex = props => {
    ...
    const columns = [
        ...
        {
            title: "Umumiy holat",
            render: (index, element) => <>{parseInt(examinationAreaId) === 23 ? element?.general_status_data?.additional_name:element?.general_status_data?.name}</>,
            width: "120",
        },
        {
            title: "Amallar",
                      ...
                      <span className={"keyboard-style"}>F2</span>
                        ...
                        <Row gutter={[0, 16]}>
                            ...
                            <Row gutter={[0, 16]}>
                                <Col xl={24}>
                                    <Table
                                        columns={parseInt(examinationAreaId) === 23 ?
