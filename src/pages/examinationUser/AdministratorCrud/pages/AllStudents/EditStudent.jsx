...
import {Row, Col, Select, Input, Form, message, Popconfirm, Alert, DatePicker, Timeline} from "antd";
    ...
    useEffect(() => {
        (async () => {
            ...
            if (parseInt(response?.status) === 1) {
                ...
                Object.assign(yy, {organization_id: JSON.parse(yy?.info)?.organization_id})
                                        ...
                                        </Timeline.Item>
                                        {
                                            parseInt(data?.exam_result) === 1 ?
                                                ...
                                                <Timeline.Item color="red">
                                                    <p>Testdan yiqildi</p>
                                                    <p>{moment(attempt?.created_at).format('YYYY-MM-DD')}</p>
                                                    <p>to'g'ri: {attempt?.correct_answers} / noto'g'ri {attempt?.incorrect_answers}</p>
                                                </Timeline.Item>:
