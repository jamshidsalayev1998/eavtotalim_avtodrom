...
const AddStudentToResubmitGroupModal = ({
  setIsModalVisible,
  isModalVisible,
  groupId,
  set_get_again,
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (index, row, counter) => (
        <>{row?.final_test_student_access?.student_fio}</>
      ),
    },
    {
      title: "Phone",
      key: "phone",
      render: (index, row, counter) => (
        <>{row?.final_test_student_access?.student_phone}</>
      ),
    },
    {
      title: "Passport",
      key: "passport",
      render: (index, row, counter) => (
        <>{row?.final_test_student_access?.student_passport}</>
      ),
    },
  ];
  const rowSelection = {
