...
export const Certificate = React.forwardRef(
  ({ examinationArea, data, src, eduType }, ref) => {
    useEffect(() => {
      setPageSize();
    });
        ...
        <div className={styleModule.secondBox}>
          ...
          <Row className={"d-flex justify-content-center  "}>
            <Col className={styleModule.xl6}>
              <img
                src={PATH_PREFIX_FILE + examinationArea?.logo}
                alt=""
                className={""}
            ...
            <Col className={styleModule.xl12}>
              <div
                className={styleModule.tashkilotNomiLabel}
                style={{ width: "100%", textAlign: "center" }}
              >
                <h6>
                  Tashkilot nomi / Наименование организации / Name of company{" "}
                </h6>
              </div>
              <h4 className={"pt-2"}>
                Milliy haydovchilik guvohnomasini olish uchun nazariy va amaliy
                imtihonlarni muvoffaqiyatli topshirganligi haqida maxsus{" "}
              </h4>
            </Col>
            <Col
              className={
                styleModule.xl6 + "  d-flex justify-content-start pl-5"
              }
            >
          ...
          <Row className={"d-flex justify-content-center  pt-2"}>
            <Col className={styleModule.xl6}></Col>
            <Col className={styleModule.xl12}>
            ...
            <Col className={styleModule.xl5}>
              <Row className={"d-flex justify-content-center  pt-4"}>
                <div className={styleModule.seriyaRaqam}>
                  <h5>
                    {" "}
                    {data?.final_access_student?.birthday
                      ? data?.final_access_student?.birthday
                      : ""}{" "}
                    &nbsp;
                  </h5>
          ...
          <Row className={"d-flex justify-content-center  "}>
            ...
            <Col className={styleModule.xl5}>
              ...
              <Row className={"d-flex justify-content-center  "}>
                <div className={styleModule.tashkilotNomiLabel80}>
                  <h6>
                    Transport vositasi turi / Тип транспортного средства /
                    Vehicle type{" "}
                  </h6>
                </div>
              </Row>
