...
export const CertificateOld = React.forwardRef(
  ({ examinationArea, data, src }, ref) => {
    useEffect(() => {
      setPageSize();
    });
    ...
    return (
      <div className={styleModule.img_box} ref={ref}>
        ...
        <div className={styleModule.secondBox}>
          <div>
            <span className={styleModule.secondBoxP}>SERTIFIKAT</span>
          </div>
          ...
          <div className={"pt-2"}>
            <span className={styleModule.fourthBoxP}>{data?.student_fio}</span>
          </div>
          <div className={"pt-2 d-flex justify-content-center"}>
            <div className={styleModule.sentenceBox}>
              <span className={styleModule.fifthBoxP}>
                Ushbu sertifikat F.I.O: <b>{data?.student_fio}</b> Pasport:{" "}
                <b>{data?.student_passport}</b> test topshiruvchiga "
                {examinationArea?.name}" test markazi testlaridan muvaffaqiyatli
                o'tganligi uchun berildi. Sertifikatning haqiqiyligini qrcode ni
          ...
          <div className={"pt-2 d-flex justify-content-between  pl-4 pr-4"}>
            ...
            <Col xl={8} className={" w-100 d-flex justify-content-center"}>
              <div className={"p-3   d-flex "}>
                <div
                  className={styleModule.borderDemo}
                  style={{ width: "150px" }}
                >
