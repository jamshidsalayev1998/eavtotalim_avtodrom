                        ...
                        <Col xl={8}>
                          <Form.Item
                            ...
                            rules={[
                              {
                                required: true,
                                message: "Qisqacha nomini kiriting!",
                              },
                            ]}
                          >
                            <Input />
                        ...
                        <Col xl={8}>
                          <Form.Item
                            ...
                            rules={[
                              {
                                required: true,
                                message: "Ish kunlarini kiriting!",
                              },
                            ]}
                          >
                            <Input />
                    ...
                    rules={[
                      {
                        required: true,
                        message:
                          "Amaliy imtihonda chiqizni bosganlik uchun jarima balini kiriting!",
                      },
                    ]}
                  >
                    <Input />
