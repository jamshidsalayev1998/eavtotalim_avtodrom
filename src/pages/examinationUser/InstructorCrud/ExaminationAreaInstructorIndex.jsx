...
import { Select, Tabs, Table, Popconfirm, message, Form, Button } from "antd";
...
const ExaminationAreaInstructorIndex = props => {
      ...
      render: (index, element) => (
        <div className="d-flex" style={{ fontSize: "20px" }}>
          <span
            ...
            style={{ color: "#fa8c16" }}
            onClick={() => showInstructor(element)}
          >
  ...
  return (
    <>
      <AddExaminationAreaInstructorModal
        setIsAddModalVisible={setIsAddModalVisible}
        isAddModalVisible={isAddModalVisible}
        setReload={setReload}
        reload={reload}
      />
      <EditExaminationAreaInstructorModal
