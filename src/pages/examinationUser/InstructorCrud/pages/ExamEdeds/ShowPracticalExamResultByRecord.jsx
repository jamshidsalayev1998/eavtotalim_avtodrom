                ...
                <ModalBody>
                    ...
                    >
                        <div>
                            ...
                            <div>
                                <p className="p-0 m-0 px-2">F.I.O: <b>{resultData?.student_fio}</b></p>
                                <p className="p-0 m-0 px-2">Tug'ilgan sana: <b>{resultData?.birthday}</b></p>
                                <p className="p-0 m-0 px-2">Pasporti: <b>{resultData?.student_passport}</b></p>
                        ...
                        {moment(
                            ...
                            <Tbody className="text-center">
                                ...
                                {resultData?.practical_result.sort((a, b) => a.sensor_id - b.sensor_id).filter(prResultFilter => {
                                ...
                                <Tr>
                                    <Td colSpan="3" className="text-left">
                                        Jami jarima ball:{" "}
                                        {parseInt(resultData?.listOfPenalties.reduce((sum, item) => sum + item?.penalty_ball, 0) + resultData?.practical_result.filter(prResultFilter => {
                                    return prResultFilter?.result === 0
                                }).reduce((sum, item) => sum + parseInt(item?.penalty_ball), 0))}
                                    </Td>
                                </Tr>
                            </Tbody>
                        </Table>
                        ...
                        <div>
                            <div>
                                <p className="my-2">
                                    ...
                                    <span>{parseInt(resultData?.practical_exam_result) === 1 ? 'Topshirdi' : 'Topshirmadi'}</span>
                                </p>
                            </div>
