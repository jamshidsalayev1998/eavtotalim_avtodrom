          ...
          <CardBody>
            <div className="crypto-buy-sell-nav mt-3">
              <Row className={"justify-content-between border p-3 "}>
                ...
                <Col xl={8} md={12} sm={24} className={"text-center"}>
                  Avtomobil nomi:{" "}
                  <b>{resultData?.merged_data?.examination_car?.name}</b>
                </Col>
                <Col xl={8} md={12} sm={24} className={"text-center"}>
                  Avtomobil raqami:{" "}
                  <b>{resultData?.merged_data?.examination_car?.number}</b>
                </Col>
                <Col xl={8} md={12} sm={24} className={"text-center"}>
                  Avtomobil gps raqami:{" "}
                  <b>{resultData?.merged_data?.examination_car?.gps_id}</b>
                </Col>
              </Row>
