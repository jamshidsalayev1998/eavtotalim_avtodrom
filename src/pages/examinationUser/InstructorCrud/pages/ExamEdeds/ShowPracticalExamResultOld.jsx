...
const ShowPracticalExamResults = (props) => {
    ...
    const match = useRouteMatch('/examination-instructor/exam-ended-students/:id')
        ...
        <>
            <div className="page-content">
                <div className="head-items-bar d-flex justify-content-between">
                   ...
                   <span className="mr-3" style={{fontSize: '20px', cursor: 'pointer', fontWeight: 'bold'}}
                                            ...
                                            <div className="card-body">
                                                <div className="row mb-1">
                                                    <div className="col-5 "
                                                        ...
                                                        <img src={PATH_PREFIX_FILE + element?.image} className="w-100"
                                                             alt=""/>
                                                    </div>
                                                        ...
                                                        hasResult(element?.sensor_id) ?
                                                            getResult(element?.sensor_id) ?
                                                                <span style={{width: '100%'}}
                                                                      className="btn btn-success">To`g`ri
                                                                bajarildi</span>
                                                                :
                                                                <span style={{width: '100%'}}
                                                                      className="btn btn-danger">Noto`g`ri
                                                                bajarildi</span>
                                                            :
                                                            <span style={{width: '100%'}}
                                                                  className="btn btn-warning">Kutilmoqda</span>
                                                ...
                                                <Row className={''}>
                                                    <Col xl={12} className={'text-center'}>
                                                        <Button className={'w-100 bg-success text-white'} icon={<i className={'fa fa-check '}></i>}></Button>
                                                    </Col>
                                                    <Col xl={12} className={'text-center'}>
                                                         <Button className={'w-100 bg-danger text-white'} icon={<i class="fa fa-ban" aria-hidden="true"></i>}></Button>
                                                    </Col>
                                                </Row>
                                                <div className={''}>
                                                ...
                                                <Row>
                                                    {
                                                        getPenalties(element?.sensor_id)?.map((elPEnalty,indexPenalty) => {
                                                            return(
                                                                <div>{elPEnalty?.examination_area_sensor_penalty?.name} uchun - {elPEnalty?.examination_area_sensor_penalty?.penalty_ball} jarima bali</div>
                                                            )
                                                        })
                                                    }
                                                </Row>
