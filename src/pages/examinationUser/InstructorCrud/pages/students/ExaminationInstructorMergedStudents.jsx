...
import {
    ...
    getAllStudents, instructorMyExaminationArea
...
const ExaminationInstructorMergedStudents = ({}) => {
    ...
    const columns = [
            ...
            render: (index, element) => <> <NavLink
                to={{
                    ...
                    state: {
                        ...
                        car_edu_type_id:element?.merged_data?.examination_car?.edu_type_id
                    }
                }}
        ...
        },
        {
            ...
            render: (index, element) => <>{element?.merged_data?.examination_car?.name} / {element?.merged_data?.examination_car?.number} / {element?.merged_data?.examination_car?.gps_id}</>
        },
        {
            title: 'Bekor qilish',
            className: '',
            render: (index, element) => <>
                <Popconfirm title={'Biriktirilgan avtomobilni bekor qilasizmi'} placement={'left'} cancelText={'Yopish'}
                            okText={'Bekor qilish'} onConfirm={() => unMerge(element)}>
                    <button className={'btn btn-outline-danger'}><i className="fa fa-car" aria-hidden="true"/> <i
