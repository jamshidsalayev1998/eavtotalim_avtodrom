...
import {getAllStudents, instructorMyExaminationArea} from "../../../../../services/api_services/instructor_student_api";
...
const ExaminationInstructorAllStudents = ({}) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (index , element) => <>{element?.edu_type_car_access?.car_count}</>
        },
        {
            title: 'Haydagan moshinalar soni',
            render: (index , element) => <>{element?.final_practical_test_records_count}</>
        },
        {
            title: 'Avtomobilga birlashtirish',
            className: 'last-td',
            render: (index, element) => <>
                <button className={'btn btn-outline-success'} onClick={() => selectStudent(element)}><i
                    class="fa fa-car" aria-hidden="true"></i> <i
    ...
    return (
        <>
            <StudentCarMargeModal examinationArea={examinationArea} setIsModalVisible={setIsModalVisible} isModalVisible={isModalVisible}
                                  selectedStudent={selectedStudent} reload={reload} setReload={setReload}/>
