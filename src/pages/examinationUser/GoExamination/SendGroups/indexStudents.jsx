...
const GoExaminationSendGroupStudents = props => {
  let match = useRouteMatch("/go-examination/send-groups/:id");
  const { Option } = Select;
  ...
  useEffect(() => {
    ...
    // setIsLoading(true);
    axios({
      url: PATH_PREFIX + "/go-examination/sended-students-by-group",
      method: "GET",
      params: {
        token,
        group_id,
            ...
            <CardBody>
              <div className="top-organizations">
                <div className="top_links_page_title">
                  ...
                  <span>
                    <b>{group?.name_uz}</b> - guruh bilan jo'natilgan
                    o'quvchilar{" "}
                    <Badge
                      color={
...
export default withTranslation()(GoExaminationSendGroupStudents);
