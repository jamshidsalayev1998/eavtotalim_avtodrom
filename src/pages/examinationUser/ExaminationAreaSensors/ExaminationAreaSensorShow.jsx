...
import {
  ...
  deleteExaminationAreaSensorPenalty,
  getExaminationAreaSensor,
  showExaminationAreaSensor,
} from "../../../services/api_services/examination_area_sensors";
import { getEduTypesForAll } from "../../../services/api_services/edu_types_api";
import AddExaminationAreaSensorPenaltiesModal from "./ExaminationAreaSensorPenalties/AddExaminationAreaSensorPenaltiesModal";
import EditExaminationAreaSensorPenaltiesModal from "./ExaminationAreaSensorPenalties/EditExaminationAreaSensorPenaltiesModal";
...
const ExaminationAreaSensorShow = props => {
  ...
  return (
    <>
      <AddExaminationAreaSensorPenaltiesModal
        isAddModalVisible={isAddModalVisible}
        reload={reload}
        setIsAddModalVisible={setIsAddModalVisible}
        setReload={setReload}
        sensorId={match?.params?.id}
      />
      <EditExaminationAreaSensorPenaltiesModal
        setReload={setReload}
        reload={reload}
        editForm={editForm}
