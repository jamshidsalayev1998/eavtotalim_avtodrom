    ...
    return (
        <Row>
            <Col xl={12} className="waitingListContainer">
                ...
                <ListQueueComponent data={remainingQueueData} transferSignal={transferSignal}/>
            </Col>
            <Col xl={12} className="accessListContainer">
                <h5>
                    Kirishi mumkin {limitedQueueData?.length} komplar {freeComputersData}
                </h5>
                <ListQueueComponent data={limitedQueueData} transferSignal={transferSignal}/>
            </Col>
            {showLargeElement && (
