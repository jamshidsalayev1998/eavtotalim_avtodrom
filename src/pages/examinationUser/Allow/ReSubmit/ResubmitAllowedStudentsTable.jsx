...
const ResubmitAllowedStudentsTable = ({}) => {
  const { Option } = Select;
                  ...
                  return (
                    <Tr key={index}>
                      ...
                      <Td>
                        <NavLink
                          to={{
                            pathname:`/come-examination/resubmit/allowed-students/${element?.id}`,
                            state:{
...
export default withTranslation()(ResubmitAllowedStudentsTable);
