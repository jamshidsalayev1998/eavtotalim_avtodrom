...
const ResubmitNoAllowedStudentsTable = ({}) => {
  const { Option } = Select;
              ...
              {data?.map((element, index) => {
                return (
                  <Tr key={index}>
                    ...
                    <Td>
                      <NavLink
                        to={`/come-examination/resubmit/no-allow-students/${element?.id}`}
                      >
                        {element?.name}
                      </NavLink>
                    </Td>
...
export default withTranslation()(ResubmitNoAllowedStudentsTable);
