...
const ResubmitShowNotAllowedStudentYet = ({}) => {
      ...
      swalWithBootstrapButtons
        ...
        .then(result => {
          if (result.isConfirmed) {
            axios({
              url:
                PATH_PREFIX + "/come-examination/resubmit/allow-group-to-exam",
              method: "POST",
              params: {
                token,
              },
              ...
              if (res?.data?.status == "1") {
                swalWithBootstrapButtons
                  ...
                  .then(() => {
                    history.push(
                      "/come-examination/allowed-students/" + element_id
                    );
                  });
              }
...
export default withTranslation()(ResubmitShowNotAllowedStudentYet);
