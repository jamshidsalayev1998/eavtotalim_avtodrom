...
const AllowedSeparatelyAllowStudentShow = props => {
  ...
  const match = useRouteMatch('/come-examination/allow-students/separately/:id')
          ...
          <Card>
            <CardBody>
              <div className="top-organizations">
                ...
                <h5 className="text-dark">{data?.final_test_student?.student_fio}</h5>
                </div>
              </div>
              <div className="crypto-buy-sell-nav mt-3">
                <Row className="d-flex ">
                  <Col xl={8} className="border p-5">
                    ...
                    <p>
                       <b>Pasport:</b> {data?.final_test_student?.student_passport}
                    </p>
                    <p>
                    ...
                    {/*</p>*/}
                    <button className={'btn btn-light w-100'} onClick={e => printToCheckSeparatelyStudentAllow(data)}><i className={'fa fa-print'}></i></button>
                  </Col>
                </Row>
              </div>
            </CardBody>
