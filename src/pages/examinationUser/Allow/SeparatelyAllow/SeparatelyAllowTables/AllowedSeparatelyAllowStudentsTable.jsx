...
import {Select, Input, Modal, Form, message, Button, Table, Popconfirm, Tooltip, Row, Col} from "antd";
...
const AllowedSeparatelyAllowStudentsTable = ({}) => {
    ...
    const columns = [
        ...
        {
            title: 'Kompyuter',
            render: (index, element) => <>{element?.merged_computer?.computer?.order}</>
        },
        // {
        ...
        // },
         {
            ...
            render: (index, element) => <>{element?.exam_result == '1' ? <Badge color={'success'}>O'tgan</Badge> :
        ...
        // },
        {
            ...
            className: ' text-center',
            render: (index, element) => <><i style={{cursor: 'pointer'}} onClick={e => select_student(element)}
