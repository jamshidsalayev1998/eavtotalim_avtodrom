...
import {AiOutlineLeft, AiOutlineDesktop, AiOutlineEnter} from "react-icons/ai";
                ...
                <div className={"d-flex justify-content-center align-items-center"}>
                    <div>
                        ...
                        <div className={"text-center mt-5  d-flex justify-content-center"}>
                            {computerKey && computer ? (
                                <button
                                    className={"rounded w-50 py-1 btn btn-primary d-flex justify-content-center"}
                                    onClick={loginByComputer}
                                >
                                    <span style={{fontSize: "35px"}}>Testni boshlash</span> <span
