...
import {
  deleteExaminationAreaCars,
  getExaminationAreaCars,
} from "../../../services/api_services/examination_area_cars";
...
const ExaminationAreaCarsIndex = props => {
  ...
  return (
    <>
      <AddExaminationAreaCarModal
        allEduTypes={allEduTypes}
        setIsAddModalVisible={setIsAddModalVisible}
        isAddModalVisible={isAddModalVisible}
        setReload={setReload}
        reload={reload}
      />
      <EditExaminationAreaCarModal
        allEduTypes={allEduTypes}
