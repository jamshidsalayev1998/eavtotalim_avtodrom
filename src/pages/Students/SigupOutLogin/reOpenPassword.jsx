...
const ReOpenPassword = ({ captchaCode }) => {
  ...
  const onFinish = async values => {
    try {
      ...
      const response = await API_V2.post(
        "/online-application/auth-forget/send-code",
        formData,
        {
          headers: {
  ...
  const onFinish2 = async values => {
    try {
      ...
      const response = await API_V2.post(
        "/online-application/auth-forget/check-code",
        formSmsData,
        {
          headers: {
            Accept: "application/json",
          ...
          >
            <div className="registration-image">
              ...
              <Divider orientation="center" className="text-dark font-size-18">
                {t("Unitilgan login parolni tiklash")}
              </Divider>
              <p>
                {t(
                  "Login parolni tiklash uchun tizimga telefon raqamingizni kiritng!"
                )}
              </p>
            </div>
            {/* telefon raqam */}
            <Form.Item
              ...
              name={"phone"}
              label={"Oldin tizimdan ro'yhatdan o'tgan telefon raqamingiz"}
            >
              <ReactInputMask
                id="phone"
                value={phone}
          ...
          >
            <div className="registration-image">
              ...
              <p className="font-size-16 text-dark">
                {t(
                  "Telefon raqamingizga borgan tekshiruv kodini kiritish orqali siz login va parolingizni tiklaysiz!"
                )}
              </p>
            </div>
